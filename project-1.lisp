...
;; DES for Question 2b
(defparameter *des-0*
  (make-fa '(("W:(1,1) H:(3,2)" right "W:(1,2) H:(3,3)")
             ("W:(1,1) H:(3,2)" down "W:(2,1) H:(3,3)")
             ("W:(2,1) H:(3,3)" up "W:(1,1) H:(2,3)")
             ("W:(2,1) H:(3,3)" down "W:(3,1) H:(2,3)") 
             ("W:(3,1) H:(2,3)" up "W:(2,1) H:(1,3)")
             ("W:(3,1) H:(2,3)" right "W:(3,2) H:(1,3)")            
             ("W:(1,1) H:(2,3)" down "W:(2,1) H:(1,3)")
             ("W:(1,1) H:(2,3)" right "W:(1,2) H:(1,3)")
             ("W:(1,2) H:(3,3)" right "W:(1,3) H:(3,3)")
             ("W:(1,2) H:(3,3)" left "W:(1,1) H:(2,3)")
             ("W:(1,3) H:(3,3)" left "W:(1,2) H:(2,3)")
             ("W:(1,3) H:(3,3)" down "W:(2,3) H:(3,2)")
             ("W:(1,2) H:(2,3)" left "W:(1,1) H:(1,3)")
             ("W:(1,2) H:(2,3)" right "W:(1,3) H:(3,3)")
             ("W:(2,3) H:(3,2)" up "W:(1,3) H:(3,3)")
             ("W:(2,3) H:(3,2)" down "W:(3,3) H:(3,1)")
             ("W:(3,3) H:(3,1)" up  "W:(2,3) H:(3,2)")
             ("W:(3,3) H:(3,1)" left "W:(3,2) H:(2,1)")
             ("W:(3,2) H:(2,1)" right "W:(3,3) H:(3,1)")
             ("W:(3,2) H:(2,1)" left "W:(3,1) H:(1,1)")
             ("W:(3,1) H:(1,1)" right "W:(3,2) H:(1,2)")
             ("W:(3,1) H:(1,1)" up "W:(2,1) H:(1,2)")
             ("W:(2,1) H:(1,2)" up "W:(1,1) H:(1,3)")
             ("W:(2,1) H:(1,2)" down "W:(3,1) H:(1,3)")
             ("W:(3,2) H:(1,2)" right "W:(3,3) H:(1,3)")
             ("W:(3,2) H:(1,2)" left "W:(3,1) H:(1,3)"))
           '("W:(1,1) H:(3,2)")
           '("W:(2,1) H:(1,3)" "W:(3,2) H:(1,3)" "W:(1,2) H:(1,3)" "W:(1,1) H:(1,3)" "W:(3,1) H:(1,3)" "W:(3,3) H:(1,3)")))
