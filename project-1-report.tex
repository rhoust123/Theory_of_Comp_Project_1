...
\clearpage
  ...
  prove via a DES model that this is the case.
    ...
    \begin{figure}[ht]
      \centering
      \includegraphics[width=0.3\textwidth]{images/Map3.jpeg}
      \includegraphics[width=0.2\textwidth]{images/wumpus3.png}
      \caption{Pursuit-Evasion Map and Corresponding DES in which the Wumpus Can Always Eat the Human}
    \end{figure}

    \begin{enumerate}
        \item Shown in figure 6 is a map in which the Wumpus can always eat the human, and a DES, represented as a finite automaton, corresponding to the map. 
        \item This DES / FA is defined in a similar manner to the FA explored in the proof for problem 2(b): $\delta$ is the movement of the human (the wumpus moves optimally in response), and $F = \{(x,y)|H:(x,y) = H:(1,3) \wedge W:(x,y) \neq H:(x,y)\}$. $q_0 = W:(1,2), H:(2,1)$. 
        \item The constructed FA in figure 6 is empty. $\therefore$, we have designed a map where the wumpus can always eat the human. $\square$
    \end{enumerate}
  ...
  DES model that this is the case.
    ...
    \begin{figure}[ht]
      \centering
      \includegraphics[width=0.3\textwidth]{images/Map4.jpeg}
      \includegraphics[width=0.2\textwidth]{images/wumpus4.png}
